...
class Business_ru_api_lib
{
    ...
    {
        $data = array();
        if (isset($_GET['app_id'])) $data['app_id'] = $_GET['app_id'];
        else return FALSE;
        if (isset($_GET['app_psw'])) $data['app_psw'] = $_GET['app_psw'];
        else return FALSE;
    ...
    {
        if (isset($params['images'])) if (is_array($params['images'])) $params['images'] = json_encode($params['images']);
